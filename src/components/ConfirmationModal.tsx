    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative bg-white w-full max-w-md rounded-2xl shadow-xl border border-slate-200 overflow-hidden z-10"
          dir="rtl"
        >
          ...
          {/* Action buttons */}
          <div className="px-6 py-4.5 bg-slate-50 border-t border-slate-150 flex items-center justify-end gap-3 rounded-b-2xl">
            <button
              type="button"
              onClick={onCancel}
              className="px-4 py-2 border border-slate-200 text-slate-500 rounded-lg text-xs font-bold hover:bg-slate-100 hover:text-slate-700 transition"
            >
              {cancelText}
            </button>
            <button
